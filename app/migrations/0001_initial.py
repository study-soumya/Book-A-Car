    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_dealer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.cardealer')),
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='app.location'),
        ),
        migrations.AddField(
            model_name='car',
            name='car_dealer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.cardealer'),
        ),
        migrations.AddField(
            model_name='car',
            name='location',
